...
from app.models import MainWheel, MainAdv, Goods, GoodsType, Cart, Address, Order, OrderGoods
...
def index(request):
    if request.method == 'GET':
        ...
        return render(request, 'app/index.html', {'wheels': wheels,
                                                       'advs': advs,
                                                       'goods': goods,
                                                       'gts': gts})
...
def cart(request):
    if request.method == 'GET':
        ...
        return render(request, 'app/cart.html', {'carts': carts})
...
def place_order(request):
    if request.method == 'GET':
        ...
        if user.id:
            ...
            return render(request, 'app/place_order.html', {'address': address, 'carts': carts})
...
def user_center_info(request):
    if request.method == 'GET':
        ...
        if user.id:
            ...
            return render(request, 'app/user_center_info.html', {'username': username, 'address': address,
...
def user_center_order(request):
    if request.method == 'GET':
        ...
        return render(request, 'app/user_center_order.html', {'no_pay_orders': no_pay_orders,
